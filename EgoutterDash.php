...
$sql="SELECT DATE_TIME, T, RH FROM plant order by ID desc limit 10";
...
if($result=$mysconn->query($sql)) {
	...
	//echo json_encode($mediciones); //Aqui si trae los datos
    } 
    else {
	echo "0 results";
    }
...
$sql2="SELECT DATE_TIME, T, RH FROM `plant` WHERE 1  order by ID desc limit 1";
...
<body>
	...
	$('#temperaturas').highcharts({
	    ...
	    series: [{
			color: 'rgba(237,223,22,0.88)',
			name: 'Celsius',
			data: <?php echo json_encode($mediciones["celsius"]); ?>
	    },
	    {
			color: 'rgba(22,144,237,0.71)',
	...
	<div class="dashboard">
		<div class="container">
			<div class="panel panel-default">
				<div class="panel-heading">TEMPERATURA ACTUAL EN CELSIUS</div>
				<div class="center"><h5><?php echo json_encode($celsius2); ?> °C</h5></div>
			</div>
		</div>
		<div class="container">
			<div class="panel panel-default">
				<div class="panel-heading">TEMPERATURA ACTUAL EN FAHRENHEIT</div>
				<div class="center"><h5><?php echo json_encode($fahr2); ?> °F</h5></div>
			</div>
		</div>
		<div class="container">
			<div class="panel panel-default">
				<div class="panel-heading">HUMEDAD ACTUAL</div>
				<div class="center"><h5><?php echo json_encode($humedad2); ?> </h5></div>
			</div>
		</div>
	</div>
	...
	<div class="dashboard">
		<div class="container">
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-heading">CONTROL DE TEMPERATURA DEL SISTEMA DE RIEGO</div>
		...
		<div class="container">
			<div class="row">
				<div class="panel panel-default">
					<div class="panel-heading">CONTROL DE HUMEDAD DEL SISTEMA DE RIEGO</div>
					<div class="panel-body">
						<div id="humedad"></div>
					</div>
				</div>
